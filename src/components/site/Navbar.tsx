      ...
      >
        ...
        >
          <a href="#top" className="flex items-center gap-3 group">
            <span className="grid place-items-center h-9 w-9 rounded-full border border-gold/40 text-gold font-display text-lg">
              E
            </span>
          ...
          <a
            href="#contact"
            className="hidden md:inline-flex items-center gap-2 rounded-full bg-gold px-5 py-2.5 text-sm font-medium text-primary-foreground hover:shadow-gold transition-all duration-300 hover:-translate-y-0.5"
          >
            Book Consultation
          </a>
        ...
        {open && (
          <div className="md:hidden mt-2 glass-strong rounded-2xl p-5 animate-fade-up">
            <ul className="space-y-3">
              {links.map((l) => (
                <li key={l.href}>
                  <a onClick={() => setOpen(false)} href={l.href} className="block py-1 text-foreground/90">
                    {l.label}
                  </a>
                </li>
              ))}
              <li>
                <a
                  ...
                  href="#contact"
                  className="mt-2 inline-flex w-full justify-center rounded-full bg-gold px-5 py-3 text-sm font-medium text-primary-foreground"
                >
                  Book Consultation
                </a>
              </li>
