  ...
  return (
    <section id="top" className="relative pt-36 md:pt-44 pb-24 overflow-hidden">
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10">
        <div className="absolute left-1/2 -top-40 -translate-x-1/2 h-[600px] w-[1100px] rounded-full blur-3xl opacity-40"
      ...
      <div className="mx-auto max-w-7xl px-6 grid lg:grid-cols-12 gap-12 items-center">
        <div className="lg:col-span-7 animate-fade-up">
          ...
          <div className="mt-9 flex flex-wrap items-center gap-4">
            <a
              href="#contact"
              className="group inline-flex items-center gap-2 rounded-full bg-gold px-7 py-3.5 text-sm font-medium text-primary-foreground hover:shadow-gold transition-all duration-300 hover:-translate-y-0.5"
            >
              Book a Consultation
            ...
            <a
              href="#services"
              className="inline-flex items-center gap-2 rounded-full glass px-7 py-3.5 text-sm font-medium hover:bg-white/5 transition-colors"
            >
              View Services
            </a>
          </div>
        ...
        <div className="lg:col-span-5 relative animate-fade-up delay-200">
          <div className="relative mx-auto max-w-md">
            <div className="absolute -inset-6 rounded-[2rem] blur-2xl opacity-50"
            ...
            <div className="relative glass-strong rounded-[2rem] p-3 shadow-luxe">
              ...
              <div className="absolute -top-5 -right-5 glass-strong rounded-full px-4 py-2 text-xs uppercase tracking-[0.2em] text-gold">
                ★ Top 1% Strategist
              </div>
            </div>
          </div>
